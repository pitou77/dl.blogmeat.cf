...
a_to_ve[i].href="/p/download.html"+xxx+"?m=1#aHR0cHM65"+ hardencryptedUrl;a_to_ve[i].rel="nofollow";a_to_ve[i].id="sedot";a_to_ve[i].target="_blank";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
